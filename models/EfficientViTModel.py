...
from .projects.efficientvit.nn import (
    ConvLayer,
    DSConv,
    EfficientViTBlock,
    FusedMBConv,
...
from .projects.efficientvit.utils import build_kwargs_from_config
...
class EfficientViTBackbone(BaseModule):
    def __init__(
        ...
        super(EfficientViTBackbone, self).__init__(init_cfg)
