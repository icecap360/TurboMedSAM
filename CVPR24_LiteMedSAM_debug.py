...
parser.add_argument(
    ...
    '--input_dir',
    type=str,
    default='/data/qasim/MedSAM/split_npzs_3chnl/official_val',
    # required=True,
...
parser.add_argument(
    ...
    '--output_dir',
    type=str,
    default='/home/qasim/Projects/TurboMedSAM/work_dir/CVPRMedSAMRepViTm11/results_npz_debug',
    help='directory to save the prediction',
)
parser.add_argument(
    '-lite_medsam_checkpoint_path',
    type=str,
    default="/home/qasim/Projects/TurboMedSAM/checkpoints/lite_medsam.pth",
...
parser.add_argument(
    '-png_save_dir',
    type=str,
    default='/home/qasim/Projects/TurboMedSAM/work_dir/CVPRMedSAMRepViTm11/overlay',
...
def medsam_inference(medsam_model, img_embed, box_256, new_size, original_size):
    ...
    low_res_pred = medsam_model.postprocess_masks(low_res_logits, 256, new_size, original_size)
...
medsam_lite_model = models.LiteMedSAM(
        settings=dict(
            image_encoder=dict(
                img_size=256,
                in_chans=3,
